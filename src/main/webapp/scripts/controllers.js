...
travelappApp.controller('MainController', ['$scope',
    function ($scope) {
    }]);

travelappApp.controller('AdminController', ['$scope',
    function ($scope) {
    }]);

travelappApp.controller('LanguageController', ['$scope', '$translate',
...
travelappApp.controller('MenuController', ['$scope',
    function ($scope) {
    }]);

travelappApp.controller('LoginController', ['$scope', '$location', 'AuthenticationSharedService',
...
travelappApp.controller('LogoutController', ['$location', 'AuthenticationSharedService',
...
travelappApp.controller('SettingsController', ['$scope', 'Account',
...
travelappApp.controller('PasswordController', ['$scope', 'Password',
...
travelappApp.controller('SessionsController', ['$scope', 'resolvedSessions', 'Sessions',
 ...
 travelappApp.controller('TrackerController', ['$scope',
    function ($scope) {
...
travelappApp.controller('MetricsController', ['$scope', 'MetricsService', 'HealthCheckService', 'ThreadDumpService',
...
travelappApp.controller('LogsController', ['$scope', 'resolvedLogs', 'LogsService',
...
travelappApp.controller('AuditsController', ['$scope', '$translate', '$filter', 'AuditsService',
