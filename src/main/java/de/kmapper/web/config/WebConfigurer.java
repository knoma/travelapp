package de.kmapper.web.config;

import com.codahale.metrics.MetricRegistry;
import com.codahale.metrics.servlet.InstrumentedFilter;
import com.codahale.metrics.servlets.MetricsServlet;
import de.kmapper.web.web.filter.CachingHttpHeadersFilter;
import de.kmapper.web.web.filter.StaticResourcesProductionFilter;
import de.kmapper.web.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer {
    ...
    private void initAtmosphereServlet(ServletContext servletContext) {
        ...
        atmosphereServlet.setInitParameter("org.atmosphere.cpr.packages", "de.kmapper.web.web.websocket");
